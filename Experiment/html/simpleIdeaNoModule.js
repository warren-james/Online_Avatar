...
function routine_1_InitExperimentRoutineBegin() {
  ...
  routine_1_InitExperimentComponents.forEach( function(thisComponent) {
...
function routine_2_WelcomeScreenRoutineBegin() {
  ...
  routine_2_WelcomeScreenComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function DemoLoopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trialIterator = DemoLoop[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisDemoLoop = result.value;
...
function DecisionTrialLoopLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trialIterator = DecisionTrialLoop[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisDecisionTrialLoop = result.value;
...
function routine_3_DemonstrationRoutineBegin() {
  ...
  routine_3_DemonstrationComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function routine_4_Trial_InstructionsRoutineBegin() {
  ...
  routine_4_Trial_InstructionsComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function routine_5a_PlaceAvatarInitRoutineBegin() {
  ...
  routine_5a_PlaceAvatarInitComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function routine_5b_PlacingAvatarRoutineBegin() {
  ...
  routine_5b_PlacingAvatarComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function routine_5c_DrivingAvatarRoutineBegin() {
  ...
  routine_5c_DrivingAvatarComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function routine_5d_TrialFeedbackRoutineBegin() {
  ...
  routine_5d_TrialFeedbackComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
